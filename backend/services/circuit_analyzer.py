...
class CircuitAnalyzer:
    ...
    def _load_api_key(self) -> str:
        ...
        raise ValueError("未找到 Claude API Key，请配置 ANTHROPIC_API_KEY 环境变量")
...
```json
{
  ...
  "errors": [
    {"type": "去耦电容缺失", "severity": "warning", "description": "U1电源引脚附近缺少去耦电容", "suggestion": "在U1的VCC引脚附近添加100nF去耦电容"}
  ]
}
```"""
